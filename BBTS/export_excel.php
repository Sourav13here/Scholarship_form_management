...
echo 'th { background-color: #667eea; color: white; font-weight: bold; padding: 10px; border: 1px solid #ddd; text-align: left; }';
echo 'td { padding: 8px; border: 1px solid #ddd; }';
echo 'tr:nth-child(even) { background-color: #f8f9fa; }';
echo '.header-row { background-color: #764ba2; color: white; font-size: 16px; font-weight: bold; }';
echo '</style>';
echo '</head>';
echo '<body>';
